...
---
## What is The Cloud Sucks?

The Cloud Sucks is a community project operated by a number of active contributors. The public list of team members [can be found on our forum](https://discuss.thecloudsucks.guide/u?group=team&order=solutions&period=all). The Cloud Sucks is legally administered by [MAGIC Grants](https://magicgrants.org), a 501(c)(3) public charity acting as our fiscal host.

As a project, we make available to the public:

- [thecloudsucks.guide](https://www.thecloudsucks.guide), this website
- [discuss.thecloudsucks.guide](https://discuss.thecloudsucks.guide), our community forum
- [code.privacyguides.dev](https://code.privacyguides.dev), public source code repositories

This privacy notice covers all The Cloud Sucks projects authorized and operated by the MAGIC The Cloud Sucks Fund executive committee.
...
Additionally, when you browse or make a purchase on [shop.thecloudsucks.guide](https://shop.thecloudsucks.guide/), this is a third-party service provided by Fourthwall. Fourthwall has published a [separate privacy policy](https://shop.thecloudsucks.guide/pages/privacy-policy) covering that platform.

## How does The Cloud Sucks collect data about me?

The Cloud Sucks collects data about you:

- When you visit our websites
- When you create and use an account on our websites
- When you post, send private messages, and otherwise participate in a community that The Cloud Sucks hosts
...
- When you link your MAGIC Grants account to your The Cloud Sucks forum account
- When you contribute to our website or other open-source projects
- When you contact us

The Cloud Sucks does not buy or receive data about you from data brokers.

## Does The Cloud Sucks sell my personal information?

No. The Cloud Sucks does not sell personal information. Additionally, The Cloud Sucks does not share personal information with third parties for the purpose of advertising.

## What personal information does The Cloud Sucks collect, and why?

### The Cloud Sucks collects information about visits to its websites
...
The Cloud Sucks stores aggregated statistics for as long as we host our websites, but those statistics do not contain data identifiable to you personally.

### The Cloud Sucks collects account data
...
To sign up for an account, The Cloud Sucks requires your email address, a username, and a password.
...
The Cloud Sucks uses your email address to:
...
You may optionally provide additional details about your account, like your name, a short biography, your location, or your birthday, on the profile settings page for your account. The Cloud Sucks makes that information available to others who have access to the forum. You don’t have to provide this additional information, and you can erase it at any time.

The Cloud Sucks stores this account data as long as your account remains open.

### The Cloud Sucks collects data about posts and other activity

The Cloud Sucks collects the content of your posts throughout our websites, plus data about bookmarks, likes, and links you follow in order to share that data with others. We also publish this activity to the public when you request it.

The Cloud Sucks also collects data about private messages that you send through the forum. The Cloud Sucks makes private messages available to senders and their recipients, and also to forum moderators and administrators.

The Cloud Sucks stores your posts and other activity as long as your account remains open.

### The Cloud Sucks collects data you give to sign up for mailing lists and announcements

When you fill out and submit a web form to sign up for mailing lists or announcements, The Cloud Sucks collects the information you put in the form, such as your e-mail address.

The Cloud Sucks stores this information until you unsubscribe from the mailing list.

### The Cloud Sucks does not collect sensitive personal information

The Cloud Sucks does not intentionally collect sensitive personal information, such as government identification numbers, information on racial or ethnic origin, political opinions, genetic data, biometric data, health data, or any of the special categories of personal data specified by the GDPR.

### The Cloud Sucks collects data about open source contributors

Contributors to The Cloud Sucks' website may be asked to provide identifying and contact information such as your name and email address.

The Cloud Sucks uses this information to maintain the integrity of our website, software, and license agreements, both our own licenses and the license between The Cloud Sucks and our contributors. The Cloud Sucks stores this information for as long as your contributions are incorporated into our open source software, including this website.

### The Cloud Sucks collects data when you donate to us

#### When you subscribe to a membership on thecloudsucks.guide
...
If the Member title or Member flair is enabled on your forum profile, The Cloud Sucks will share your username and profile picture on our websites for the purposes of acknowledging your donation to the project. You may revoke this consent at any time by removing the title and flair from your public profile, and we will no longer share your donation status publicly. This will not affect your access to members-only benefits. It may take until the next website release for your data to be removed from public visibility.
...
If you choose to make your donation public during or after the checkout process on GitHub, The Cloud Sucks will share your username and profile picture on our websites for the purposes of fulfilling your request. You may revoke this consent at any time, and we will no longer share your donation status publicly. It may take until the next website release for your data to be removed from public visibility.
...
However, if you optionally link your `donate.magicgrants.org` account to your The Cloud Sucks forum account, our forum collects some personal data which is covered by this notice: namely your forum username and whether you have an active membership.
...
The Cloud Sucks stores this data for as long as we are in contact with you, or for up to 1 year after your last contact with us. You have the right to request all data related to your private communication with us be deleted at any time, and we will generally do so within 7 days.

### The The Cloud Sucks website stores local data
...
### The The Cloud Sucks website uses cookies
...
### The The Cloud Sucks forum uses cookies
...
### The Cloud Sucks makes regular backups of all data

The Cloud Sucks keeps automated backups of **all** data it collects. These backups are stored for up to 30 days. Any time you delete personal data from our websites, a copy may be retained in backup archives until those archives are pruned.

## Does The Cloud Sucks use personal information for marketing purposes?

The Cloud Sucks may use personal data about our users in order to directly promote our own resources, such as for sharing new resources or when fundraising. We also use the information you give us when signing up for our mailing lists and announcements to send those messages.
...
The Cloud Sucks never provides or sells your data to third-parties for marketing purposes.
...
The Cloud Sucks does not respond to the (now deprecated) [Do Not Track HTTP header](https://en.wikipedia.org/wiki/Do_Not_Track).

## Where does The Cloud Sucks store data about me?
...
## Does The Cloud Sucks comply with the EU General Data Protection Regulation?

The Cloud Sucks respects rights under the European Union’s General Data Protection Regulation (GDPR). Information that GDPR requires The Cloud Sucks to give can be found throughout this privacy notice, including information on the rights of data subjects.
...
The Cloud Sucks generally processes your data using 3 of the 6 lawful bases for processing set out in Article 6 of the GDPR:
...
### Does The Cloud Sucks make international data transfers?

Currently:

- The Cloud Sucks [processes personal data on servers outside the European Union](#where-does-privacy-guides-store-data-about-me).
- The Cloud Sucks uses [subprocessors](#subprocessors-used-by-privacy-guides) with personnel and computers outside the European Union.
- The Cloud Sucks has [personnel](https://discuss.thecloudsucks.guide/u?group=team&order=solutions&period=all) in the United States, Australia, and other non-EU countries without EU adequacy decisions under GDPR. These people need access to forum personal data in order to keep forums running, address security concerns, respond to privacy-related requests from users, field technical support requests, and otherwise assist users.
- The Cloud Sucks is very likely subject to section 702 of the Foreign Intelligence Surveillance Act in the United States, a law that the European Court of Justice has found inadequately protects the rights and freedoms of data subjects.
- The Cloud Sucks has never received any order or request for personal data under FISA 702 or any similar national security or surveillance law of any other country. The Cloud Sucks is not subject to any court order or legal obligation that would prevent it from disclosing the existence or non-existence of such an order or request.
- The Cloud Sucks has a policy for how we will respond to those orders and requests, in case we ever receive one. The Cloud Sucks will suspend processing, notify any affected user, minimize disclosure, and resist disclosure of personal data, all as the law allows.

Because national security and surveillance laws may be in conflict with European data protection rules, The Cloud Sucks continually reassesses the practical reach of these laws to ensure our data transfers are adequately safeguarded.

## Does The Cloud Sucks comply with the California Consumer Privacy Act and other US state comprehensive privacy laws?

The Cloud Sucks is not a "business" for the purposes of the California Consumer Privacy Act (CCPA) or a “controller” directly subject to other US state comprehensive privacy laws.

The Cloud Sucks **never** sells your personal information.
...
On the forum, your [profile settings](https://discuss.thecloudsucks.guide/my/preferences/account) include a link to download all of your activity in standard Comma Separated Values format.

If you do not have an account with us but have a data access request, please [contact us](about.md).

## How can I change or erase data about me?

You can change your account data at any time by visiting the profile settings page for your account. You also have the option to delete your profile on the settings page of your account. Utilizing this option begins the process of erasing or anonymizing The Cloud Sucks' records of data you provided for your account. Forum administrators and moderators also have the option to erase and anonymize accounts.

You may also be able to edit, anonymize, or erase your posts. When you edit posts, The Cloud Sucks will keep all versions of your posts. These old versions of posts are not public, but may be accessed by forum moderators or administrators.

## Does The Cloud Sucks make automated decisions based on my data?

### The The Cloud Sucks forum classifies posts as spam automatically
...
### The The Cloud Sucks forum uses data about your posts and activity to set trust levels
...
### The The Cloud Sucks forum uses community flags to take automated actions
...
## Does The Cloud Sucks share data about me with others?

The Cloud Sucks shares account data with others as described in [the section about account data](#privacy-guides-collects-account-data).

The Cloud Sucks shares data about your posts and other activity as described in [the section about forum data](#privacy-guides-collects-data-about-posts-and-other-activity-on-our-forum).

### Subprocessors used by The Cloud Sucks

The Cloud Sucks uses the following subprocessors, and may share personal data with the service providers we use in order to host our website, deliver content, secure our services, store data, host and manage our open source website, and provide user support.
...
| [Fediverse Communications LLC](https://fediverse.us) (USA) | PeerTube | For hosting public videos produced by The Cloud Sucks which are shared or embedded on this website. | USA | [More information](https://neat.tube/about/instance) |
...
| [GitHub](https://github.com) (USA) | [Sponsors](https://github.com/sponsors/privacyguides) | For collecting payments for gifts to The Cloud Sucks | USA | [Privacy Notice](https://docs.github.com/en/site-policy/privacy-policies/github-general-privacy-statement) |
...
| [Triplebit](https://www.triplebit.org) (USA) | [Umami Statistics](https://stats.triplebit.net/share/S80jBc50hxr5TquS/www.thecloudsucks.guide) | For compiling aggregated statistics of our website visitor data based on server-side visitor info submissions | USA | [Privacy Notice](https://www.triplebit.org/privacy) |
...
## Does The Cloud Sucks delete inactive accounts?

The Cloud Sucks deletes accounts that have no public activity when they have gone unused for 3 years. If the account has public activity, we will not delete it regardless of inactivity because your profile data is required to continue to publish your activity per your original request.

You can always request the deletion of your data at any time regardless of this policy.

## How can I contact The Cloud Sucks about privacy?

You can send questions, requests, and complaints via email to us at <team@thecloudsucks.guide>. You may also use Signal or another contact method detailed [here](about.md#contact-us) to contact us more securely.

For complaints under GDPR more generally, you always have the option to lodge complaints with your local data protection supervisory authorities.

## Where do I find out about changes?

This version of The Cloud Sucks' privacy notice took effect on September 24, 2025.

The Cloud Sucks will post the next version here: <https://www.thecloudsucks.guide/en/privacy/>.

In future versions, The Cloud Sucks may change how it announces changes. In the meantime, The Cloud Sucks may update its contact information without announcing a change. Please refer to <https://www.thecloudsucks.guide/en/privacy/> for the latest contact information at any time.

A full revision [history](https://github.com/thecloudsucks/thecloudsucks.guide/commits/main/docs/privacy.md) of this page can be found on GitHub.
