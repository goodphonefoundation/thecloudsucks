...
Our Code of Conduct applies within all project spaces, as well as when an individual is representing the The Cloud Sucks project in other communities.
...
If you have a problem elsewhere, or a problem that our community moderators are unable to resolve, reach out to `dominic@thecloudsucks.guide`.
