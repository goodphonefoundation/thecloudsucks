...
These are policies formally adopted by The Cloud Sucks' executive committee, and take precedence over all other statements expressed on this website.
...
=== "Current Version (1)"
    ...
    - The Cloud Sucks **shall not** proactively reach out to vendors asking for product samples or review accounts.
    - The Cloud Sucks **shall not** accept test/review accounts for subscription cloud services.
    - The Cloud Sucks **may** accept freely-provided product samples for one-time purchase software applications which run locally, given they don't require a subscription for continued operation.
    - The Cloud Sucks **may** accept freely-provided samples of hardware products.
        - The Cloud Sucks **may** accept a freely-provided subscription service associated with a hardware product, if such a subscription/license is necessary to use the product.
    - The Cloud Sucks **must not** enter into an agreement pertaining to our editorial opinion with the vendor in order to receive a sample or publish a review. All freely-provided items must be strictly "no strings attached."
